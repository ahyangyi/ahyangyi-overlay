...
RDEPEND="
	...
	>=dev-python/anthropic-0.78[${PYTHON_USEDEP}]
	>=dev-python/asyncssh-2.21[${PYTHON_USEDEP}]
	>=dev-python/fastmcp-2.12[${PYTHON_USEDEP}]
	>=dev-python/fastapi-0.115[${PYTHON_USEDEP}]
	>=dev-python/google-genai-1.56[${PYTHON_USEDEP}]
	...
	>=dev-python/openai-2.14[${PYTHON_USEDEP}]
